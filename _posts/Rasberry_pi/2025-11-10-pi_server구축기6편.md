...
← 이전 글: [Pi-Server 구축기 5편: systemctl로 서비스 등록하기](./2025-11-09-pi_server구축기5편/index.html)
→ 다음 글: [Pi-Server 구축기 END : 자동 복구 및 앞으로의 방향성](./2025-11-10-pi_server구축기End/index.html)
