...
브라우저에서 `http://<REDACTED_LOCAL_IP>:3000` 접속!
...
이 설정으로 웹 브라우저에서 `http://<REDACTED_LOCAL_IP>:3000` 접속 시
...
← 이전 글: [Pi-Server 만들기 1편: 아키텍처 굽기와 SSH 연결](./2025-11-09-pi_server구축기1편/index.html)
→ 다음 글: [Pi-Server 만들기 3편: Cloudflare Tunnel 연결](./2025-11-09-pi_server구축기3편/index.html)
